...
export function isINotification(
  notificationValue: INotification,
): notificationValue is INotification {
  return (
    'notificationType' in notificationValue && 'displayed' in notificationValue
  );
}
